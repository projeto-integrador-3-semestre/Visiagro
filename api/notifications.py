    ...
    try:
        ...
        for farm, dist, region_lat, region_lng, area_radius_km in targets:
            ...
            public_alert = {
                ...
                "prediction_id": prediction.get("id") if isinstance(prediction, dict) and prediction.get("id") is not None else None,
    ...
    for prediction in resp.data or []:
        ...
        try:
            ...
            public_alert = {
                ...
                "target_farm_id": farm.get("id"),
                "source_user_id": source_user_id,
                "prediction_id": prediction.get("id") if prediction.get("id") is not None else None,
                "label": label,
